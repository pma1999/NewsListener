...
7.  **Variedad del Español y Pureza Lingüística:**
    *   **Castellano de España:** Genera el guion **exclusivamente en castellano de España (español peninsular)**. Presta especial atención al vocabulario (p. ej., **"coche"** en lugar de "carro", **"ordenador"** en lugar de "computadora", **"gafas"** en lugar de "lentes", **"móvil"** en lugar de "celular", **"piso"** para apartamento), las expresiones idiomáticas y las construcciones gramaticales propias de España, incluyendo el uso de **"vosotros"** (p. ej., "vosotros tenéis", "a vosotros") para el plural informal cuando el contexto lo requiera.
    *   **Tratamiento de Términos en Inglés:** No obstante lo anterior, si un nombre propio de persona (ej. 'Donald Trump'), lugar (ej. 'Silicon Valley'), organización, o un término técnico o nombre de producto (ej. 'Internet', 'iPhone', 'Big Data') es originalmente en inglés y se utiliza comúnmente en su forma inglesa en los medios de comunicación de España, **dicho término debe mantenerse escrito en inglés** dentro del guion. No intentes traducirlo ni adaptarlo fonéticamente al español en el script.
    *   **Regla General:** Aparte de los casos específicos de términos en inglés mencionados, no utilices palabras de otras lenguas ni de otras variantes del español. El cuerpo principal del guion debe ser puro castellano de España.
