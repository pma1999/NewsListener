...
const PreferencesPage: React.FC = () => {
  ...
  if (isError) {
    return (
      <div className="flex flex-col items-center justify-center p-10 bg-red-900/20 border border-red-700 rounded-lg">
        ...
        <p className="text-red-300">We couldn't fetch your preferences. Please try again later.</p>
  ...
  return (
    <div className="container mx-auto p-4 max-w-3xl">
      <h1 className="text-3xl sm:text-4xl font-bold mb-8 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500 py-2">
